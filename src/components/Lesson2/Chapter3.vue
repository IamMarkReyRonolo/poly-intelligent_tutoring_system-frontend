				...
				<v-card>
					<div class="welcomeMessage">
						...
						<v-btn
							text
							color="success"
							href="https://www.mathsisfun.com/algebra/polynomials-multiplying.html"
							target="_blank"
							>Resource 1</v-btn
						>
						...
						<v-btn
							text
							color="success"
							href="https://courses.lumenlearning.com/ivytech-collegealgebra/chapter/multiplying-polynomials/"
							target="_blank"
							>Resource 2</v-btn
						>
						...
						<v-btn
							text
							color="success"
							href="https://www.storyofmathematics.com/multiplying-polynomials/"
							target="_blank"
							>Resource 3</v-btn
						>
					...
					lessons.data.lessons.forEach((element) => {
						if (element.name == "Polynomial Operations") {
							...
							element.chapter.forEach((chap) => {
								if (chap.chapter_name == "Multiplication of Polynomials") {
									this.chapter = chap;
								}
							});
						}
			...
			async takeExercise() {
				try {
					...
					if (this.chapter.exercise_status != "Passed") {
						this.$router.push("Multiplication of Polynomials/3/confirmation");
					} else {
						this.$router.push(
							"Multiplication of Polynomials/3/exercise/result"
						);
					}
				} catch (error) {
					this.error = error;
